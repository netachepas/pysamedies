...
speed = [2, 2]                                  # déplacement (en pixels) par tour, pour les directions x et y
black = 0, 0, 0                                 # definir une couleur. tuple de rouge, vert, bleu  (valeurs entre 0 et 250)
ball = pygame.image.load("ball.bmp")            # load retourne une autre surface, contenant l'image ball.bmp
